...
//		quad_quat_state[0] = pdata_out->quaternion[3];
...
//		if (e0 < 0) {
//			quaternion_ganz[0] = -quaternion_ganz[0];
//			quaternion_ganz[1] = -quaternion_ganz[1];
...
//		);
//
//		quaternion_ganz[0] = quaternion_ganz[0] / norm;
//		quaternion_ganz[1] = quaternion_ganz[1] / norm;
//		quaternion_ganz[2] = quaternion_ganz[2] / norm;
//		quaternion_ganz[3] = quaternion_ganz[3] / norm;
...
//		q_mix[0] = (
//			qd_red_inverse[0] * quaternion_ganz[0] -
//			qd_red_inverse[1] * quaternion_ganz[1] -
//			qd_red_inverse[2] * quaternion_ganz[2] -
//			qd_red_inverse[3] * quaternion_ganz[3]
//		);
//
//		q_mix[1] = (
//			qd_red_inverse[1] * quaternion_ganz[0] +
//			qd_red_inverse[0] * quaternion_ganz[1] -
//			qd_red_inverse[3] * quaternion_ganz[2] +
//			qd_red_inverse[2] * quaternion_ganz[3]
//		);
//		q_mix[2] = (
//			qd_red_inverse[2] * quaternion_ganz[0] +
//			qd_red_inverse[3] * quaternion_ganz[1] +
//			qd_red_inverse[0] * quaternion_ganz[2] -
//			qd_red_inverse[1] * quaternion_ganz[3]
//		);
//		q_mix[3] = (
//			qd_red_inverse[3] * quaternion_ganz[0] -
