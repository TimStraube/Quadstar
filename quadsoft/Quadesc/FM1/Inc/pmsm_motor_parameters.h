...
#define RS                     0.49 /* Stator resistance , ohm*/
#define LS                     0.000205 /* Stator inductance, H
...
#define NOMINAL_CURRENT         816
#define MOTOR_MAX_SPEED_RPM     4446 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  3.1 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -816 /*!< Demagnetization current */
