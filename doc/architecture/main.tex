...
\begin{tikzpicture}[node distance=2cm, auto, >=latex', thick]
  ...
  \node[draw, rounded rectangle, fill=red!20, left=3cm of mcu, minimum width=2.5cm] (pwh) {\#48 Power Wiring Harness};
  
  % Akku, Ladestation und Testbench
  \node[draw, rounded rectangle, fill=red!20, left=2.5cm of pwh, minimum width=2.5cm] (akku) {\#21 Akku};
  \node[draw, rounded rectangle, fill=red!20, left=4.5cm of akku, minimum width=2.5cm] (ladestation) {\#45 Loading Station};
  ...
  \node[draw, dashed, rounded rectangle, fit=(mcu) (esc) (motor) (rx) (qsu) (akku) (step) (wings) (pwh), inner sep=1cm, label=below:{\textbf{Quadcopter}}] (quadbox) {};
...
\begin{tikzpicture}
  \node[draw, rectangle, fill=white!90, font=\small, align=left] at (0,0) {
    ...
    \tikz\node[draw, rounded rectangle, fill=violet!20, minimum width=0.8cm, minimum height=0.4cm] {};\ Communication\\[0.3cm]
    \textbf{Hinweis:}\\
