...
\begin{center}
	\includegraphics[scale=0.3]{../Bilder/0047 Eulerwinkel Zufällige Aktionen.png
...
\begin{center}
	\includegraphics[scale=0.78]{../Bilder/0001 Quadcopterregler.png}{\\Für den später verwendeten Regler wurden die Solltrajektorie zu einem Sollgeschwindigkeitsvektor vereinfacht und nur die Geschwindigkeit geregelt. Das Bild ist entnommen aus der ursprünglichen Veröffentlichung \ref{link:ETH}.}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.26]{../Bilder/0046 Weltmodell ohne Hintergrund.png
...
\begin{center}
  \includegraphics[
    width=0.7\textwidth, 
    keepaspectratio
  ]{../Bilder/0032 multi-layer-perzeptron.png}{\\Ein voll verknüpftes Netzwerk in welchem alle Knoten rot sind die durch das Gewicht $w_{1,1}^{(S)}$ beeinflusst werden \ref{link:MaschinellesLernen}}
\end{center}
...
\begin{center}
	\includegraphics[width=0.98\textwidth, keepaspectratio]{../Bilder/0058 Tensorboard.png}{\\Tensorboard welches ein Training mit PPO zeigt bei dem die mittlere Episodenanzahl konstant ist und die Belohnung im Rollout und in der Evaluation nicht wie gewünscht kontinuirlich steigt.}
\end{center}
...
\begin{center}
	\includegraphics[width=0.9\textwidth, keepaspectratio]{../Bilder/0062 ThreeJS Beispielselektor.png}{\\ThreeJS Beispielselektor mit Beispiel tsl/earth gewählt \ref{bild:3}}
\end{center}