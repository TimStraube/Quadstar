...
\begin{align}\label{zustandsvektor:zustandsvektor}
	...
	\begin{pmatrix}
		...
		((I_{B,yy} - I_{B,zz}) \dot{\theta} \dot{\psi} + F_{\phi} w) \frac{1}{I_{B,xx}}\\
		((I_{B,zz} - I_{B,xx}) \dot{\phi} \dot{\psi} + F_{\theta} l) \frac{1}{I_{B,yy}}\\
		((I_{B,xx} - I_{B,yy}) \dot{\phi} \dot{\theta} + F_{\psi})\frac{1}{I_{B,zz}}
	\end{pmatrix}.
\end{align}
