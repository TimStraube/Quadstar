...
#define MAX_APPLICATION_SPEED_RPM       2412 /*!< rpm, mechanical */
...
#define OBS_MEAS_ERRORS_BEFORE_FAULTS    8  /*!< Number of consecutive errors
...
#define PID_TORQUE_KP_DEFAULT         2689
#define PID_TORQUE_KI_DEFAULT         1793
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2689
#define PID_FLUX_KI_DEFAULT           1793
...
#define PID_SPEED_KP_DEFAULT          2195/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          2014/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
