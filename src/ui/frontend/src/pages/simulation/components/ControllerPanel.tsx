  ...
  return (
    <div style={{
      ...
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6}}>
        ...
        <button onClick={() => setOpenPanel(op => op === 'controller' ? null : 'controller')} style={{background: 'transparent', border: 'none', color: 'white', cursor: 'pointer'}}>{openPanel === 'controller' ? '▾' : '▸'}</button>
      </div>
